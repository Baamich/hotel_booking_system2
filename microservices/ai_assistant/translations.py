...
TRANSLATIONS = {
    'rus': {
        ...
        'login_to_book': 'Войдите в аккаунт, чтобы забронировать',
    },
    'eng': {
    ...
    'rom': {
        ...
        'book_room': 'Rezervă cameră',
        'first_name': 'Prenume',
        'last_name': 'Nume',
        'phone': 'Telefon',
        'email': 'Email',
        'first_name_placeholder': 'Ion',
        'last_name_placeholder': 'Popescu',
        'proceed_to_payment': 'Mergi la plată',
        'login_to_book': 'Autentifică-te pentru rezervare',
    }
}
